...
public class W_SalesMothlyCommand implements Acommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		W_SalesMonthly_Dao dao = new W_SalesMonthly_Dao();
		
		ArrayList<W_SalesMonthly_Dto> dtos = dao.salesMonthly(day);
